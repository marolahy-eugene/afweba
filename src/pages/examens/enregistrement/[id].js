...
import EnregistrementForm from '@/components/enregistrement/EnregistrementForm';
...
export default function EnregistrementPage() {
  ...
  return (
      <>
        {/* En-tête fixe avec bouton retour et titre */}
        <div className="fixed top-16 left-60 right-0 bg-custom-3 z-10 px-6 py-4 flex items-center shadow-md">
          ...
          <h2 className="text-2xl font-semibold text-gray-200 dark:text-white ml-4">
            Enregistrement de l'examen : {patient ? `${patient.nom} ${patient.prenom}` : examen.id}
          </h2>
        </div>
        <Layout>
          <div className="p-6">
